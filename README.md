...
2. **Text classification** — TF-IDF vectorization (10K features, unigrams +
   ...
   product category from complaint narrative. 9 consolidated categories after
   merging duplicate/legacy labels. Model and vectorizer are serialized
...
- Sentiment scoring uses VADER (rule-based); doesn't capture nuanced or
  sarcastic language
- Rare product categories have limited training data, reducing model
  reliability for those classes
